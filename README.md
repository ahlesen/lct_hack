...
docker exec -it 326 /usr/share/elasticsearch/bin/elasticsearch-reset-password -u elastic
docker cp 326:/usr/share/elasticsearch/config/certs/http_ca.crt ./src/elastic/certs/
```
