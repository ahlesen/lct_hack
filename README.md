...
docker exec -it d2e /usr/share/elasticsearch/bin/elasticsearch-reset-password -u elastic
docker cp d2e:/usr/share/elasticsearch/config/certs/http_ca.crt ./src/elastic/certs/
```
